    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [django.contrib.postgres.indexes.GinIndex(fields=['config'], name='resume_buil_config_821990_gin')],
            },
        ),
        migrations.AddField(
            model_name='resume',
            name='template',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='resumes', to='resume_builder.resumetemplate'),
        ),
        migrations.CreateModel(
            name='TechnicalSkill',
            fields=[
